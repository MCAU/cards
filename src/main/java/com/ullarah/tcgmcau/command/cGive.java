            ...
            if (args.length >= 3 && args.length <= 4) {
                ...
                if (recPlayer != null) {
                    ...
                    if (recCard.matches("[0-9]+") || mInit.cardCode.get(recCard) != null) try {
                        ...
                        recPlayer.sendMessage(mInit.getMsgPrefix() + "You received " + ChatColor.GOLD + recAmount + " " + ChatColor.AQUA + cardName + ChatColor.WHITE + " card from " + ChatColor.GREEN + srcPlayer + ChatColor.WHITE + ".");
